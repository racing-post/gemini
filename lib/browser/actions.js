...
var Actions = inherit({
    ...
    waitForElementToShow: function waitForElementToShow(selector, timeout, strategy) {
        if(!strategy && typeof timeout === 'string') {
            strategy = timeout;
        }
    ...
    waitForElementToHide: function waitForElementToHide(selector, timeout, strategy) {
        if(!strategy && typeof timeout === 'string') {
            strategy = timeout;
        }
    ...
    _waitElementAction: function(method, selector, options) {
        ...
        this._pushAction(method, function() {
            var strategy = options.strategy === 'xpath' ? 'waitForElementByXPath' : 'waitForElementByCssSelector';
            return _this._driver[strategy](selector, options.asserter, timeout)
                .fail(function() {
...
module.exports = inherit(Actions, {
    __constructor: function(browser) {
        this.__base(browser);
